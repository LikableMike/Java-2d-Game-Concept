...
public class Keyb implements KeyListener{
	...
	private char keybPollX(){
		...
		//My Diagonal additions should be looked for first
		else if(isKeyDown(KeyEvent.VK_W) && isKeyDown(KeyEvent.VK_D))	return 'D';
		else if(isKeyDown(KeyEvent.VK_A) && isKeyDown(KeyEvent.VK_W))	return 'W';
		else if(isKeyDown(KeyEvent.VK_A) && isKeyDown(KeyEvent.VK_S))	return 'A';
		else if(isKeyDown(KeyEvent.VK_S) && isKeyDown(KeyEvent.VK_D))	return 'S';
		...
		//My Diagonal additions
		else if(isKeyDown(KeyEvent.VK_W) && isKeyDown(KeyEvent.VK_D))	return '~';
